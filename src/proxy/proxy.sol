...
contract BuggyProxy {
    address public implementation; // is the contract address you’ll give to users to interact with your contract
    address public admin; // is the contract to manage ownership and upgrades
