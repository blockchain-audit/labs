...
//     // time in second of reward
//     uint256 public duration = 7 days; // [sec] time for payout
//     //when finish reward
//     uint256 public finish = 0;      // [sec] finish reward time
//     //last time that reward update
//     uint256 public updated;         // [sec] last reward update
//     // how many reward get in second
//     uint256 public rate ;   // [per] reward rate per sec
//     //reward/totalsupply - reward per token until this time
