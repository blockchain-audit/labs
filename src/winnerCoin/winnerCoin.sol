...
//     function guessNumber(uint256 _numbers, MyToken coins) external timeIsNotFinished(){
...
//     function setEndDate(uint256 duration) external isOwner timeIsNotFinished {
